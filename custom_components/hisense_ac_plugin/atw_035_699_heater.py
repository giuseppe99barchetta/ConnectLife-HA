...
class Atw035699WaterHeater(CoordinatorEntity, WaterHeaterEntity):
    ...
    @property
    def is_on(self) -> bool:
        """Return whether water heater is on."""
        if not self._device:
            return False
                    ...
                    for key, value in work_mode_attr.value_map.items():
                        if operation_mode == STATE_HEAT and ("制热" in value or STATE_HEAT in value.lower()):
                            ...
                            break
                                ...
                                "热水+自动" in value or STATE_HOT_WATER_AUTO in value.lower()):
                            hisense_mode = key
                            break
                            ...
                            break
                                ...
                                "热水+制热" in value or STATE_HOT_WATER_HEAT in value.lower()):
                            hisense_mode = key
                            break
